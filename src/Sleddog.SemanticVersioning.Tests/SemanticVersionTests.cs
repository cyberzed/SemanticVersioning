...
namespace SemanticVersioning.Tests
{
    public class SemanticVersionTests
    {
        ...
        public void CanNotInstantiateWithSpecialVersionWithNormalType(SemanticVersionType semanticVersionType,
                                                                      ushort major, ushort minor,
                                                                      ushort patch,
                                                                      string[] specialVersionParts)
        {
            Assert.Throws<ArgumentOutOfRangeException>(
                () => new SemanticVersion(major, minor, patch, specialVersionParts, semanticVersionType));
        }

        [Theory]
        [InlineAutoData(SemanticVersionType.Build)]
        public void ThrowsExceptionOnMalformedSpecialVersionParts(SemanticVersionType semanticVersionType, ushort major,
                                                                  ushort minor,
                                                                  ushort patch,
                                                                  string[] specialVersionParts)
        {
            ...
            Assert.Throws<ArgumentException>(
                () => new SemanticVersion(major, minor, patch, versionParts, semanticVersionType));
        }
        ...
        public void SpecialVersionsGetsSetCorrectly(SemanticVersionType semanticVersionType, ushort major, ushort minor,
                                                    ushort patch,
                                                    string[] specialVersionParts)
        {
        ...
        [InlineAutoData(SemanticVersionType.PreRelease)]
        [InlineAutoData(SemanticVersionType.Build)]
        public void SpecialVersionsDoesntAllowNullSpecialVersionParts(SemanticVersionType semVerType, ushort major,
                                                                      ushort minor, ushort patch)
        {
        ...
        [InlineAutoData(SemanticVersionType.PreRelease)]
        [InlineAutoData(SemanticVersionType.Build)]
        public void ToStringFormatsCorrectlyWithSpecialVersions(SemanticVersionType semVerType, ushort major,
                                                                ushort minor, ushort patch,
        ...
        [InlineAutoData(SemanticVersionType.PreRelease)]
        [InlineAutoData(SemanticVersionType.Build)]
        public void SpecialTypeHashCodeVerification(SemanticVersionType semVerType, ushort major, ushort minor,
                                                    ushort patch,
                                                    string[] specialParts)
        {
        ...
        private string FormatVersion(SemanticVersion semVer)
        {
            switch (semVer.SemanticVersionType)
            {
                case SemanticVersionType.PreRelease:
                    return string.Format("{0}.{1}.{2}-{3}", semVer.Major, semVer.Minor, semVer.Patch,
                        semVer.SpecialVersion);
